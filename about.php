    ...
    <div class="para_bg" id="about_para_bg">
      <div class="about_para_content" id="about_para_content">
        ...
        <div class="container-fluid about_content">
          <p>permashutters is where i keep a variety of things that interest me</p>
          <p>since there are many, i've set up some different spaces for different topics that tickle my fancy</p>
          <hr class="perma_hr">
  ...
  <section class="para_page" id="games_para_page">
    ...
    >
      <div class="para_content" id="games_para_content"
        data-center="opacity: 1; position: relative; transform: translate(0px, 0px);"
        data-center-top="opacity: 0.5;"
        data--100-bottom="opacity: 0; position: relative; transform: translate(-500px, -500px);"
        data--100-top="opacity: 0.5; position: relative; transform: translate(500px, 500px);"
