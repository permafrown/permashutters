...
<body>
    <h1 class="title_centered" style="color: #0F0;">perma<i class="fa fa-ravelry" aria-hidden="true"></i>games</h1>
    <p><a href="../index.php">home</a> | <a href="../about.php">about</a> | <a href="../content.php?cat=games">games</a></p>
    <hr class="perma_hr">
