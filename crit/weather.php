    ...
    <form method="GET">
      ...
      <div class="jumbotron">
        ...
        <div class="jumbotron">
            <?php
            if ($weatherArray != "") {
                echo "<iframe width=\"600\" height=\"450\" frameborder=\"0\" style=\"border:0\" src=\"https://www.google.com/maps/embed/v1/place?key=AIzaSyDbR0TOMMHuzQFYlIAZsEA1TaqgYG526k4&q=Space+Needle,Seattle+WA\" allowfullscreen></iframe>";
            } else {
                echo "";
            }
             ?>
