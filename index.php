...
<body>
  ...
  <div class="column shutters">
    ...
    <a class="shutt col-xs-2 games_shutt" href="content.php?cat=games">games</a>
    <a class="shutt col-xs-2 fauna_shutt" href="content.php?cat=fauna">fauna</a>
    <a class="shutt col-xs-2 science_shutt" href="content.php?cat=science">science</a>
    <a class="shutt col-xs-2 words_shutt" href="content.php?cat=words">words</a>
    <a class="shutt col-xs-2 sundry_shutt" href="content.php?cat=sundry">sundry</a>
    <a class="shutt col-xs-2 media_shutt" href="content.php?cat=media">media</a>
  </div>
  <hr class="perma_hr">
  <!-- END SHUTTER MENU -->
