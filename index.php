...
<body>
  ...
  <!-- MAIN TITLE -->
  <h1 class="main_title" style="margin-top: 2.5%;"> <span style="color: #0F0;">permashutters</span><br/><small class="subtext">a collection of things i find interesting</small></h1>
  <!-- END MAIN TITLE -->
